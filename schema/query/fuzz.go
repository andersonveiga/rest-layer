...
//     $ go-fuzz-build -func FuzzPredicate -o fuzz-query-predicate.zip github.com/andersonveiga/rest-layer/schema/query
...
//
//     $ go test ./schema/query -update-fuzz-corpus
//     $ go-fuzz-build -func FuzzProjection -o fuzz-query-projection.zip github.com/andersonveiga/rest-layer/schema/query
...
//
//     $ go test ./schema/query -update-fuzz-corpus
//     $ go-fuzz-build -func FuzzSort -o fuzz-query-sort.zip github.com/andersonveiga/rest-layer/schema/query
